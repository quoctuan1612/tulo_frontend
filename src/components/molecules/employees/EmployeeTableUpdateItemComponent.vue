<template>
  <v-dialog v-model="dialog" persistent max-width="900px">
    <v-card>
      ...
      >
        <span class="title-form">Cập nhật thông tin nhân viên</span>
      </v-toolbar>
      <v-card-text>
        <v-form class="px-3">
          <v-row>
          ...
          <v-row>
            <v-col cols="6">
              <v-select
                v-model="employee_data.master_country_id"
            ...
            <v-col cols="6">
              <v-select
                v-model="employee_data.master_province_id"
          ...
          <v-row>
            <v-col cols="6">
              <v-select
                v-model="employee_data.master_district_id"
            ...
            <v-col cols="6">
              <v-select
                v-model="employee_data.master_ward_id"
                :items="wards_data"
                item-text="name"
                item-value="id"
                label="Xã/Phường"
          ...
          <v-row>
            <v-col cols="6">
              <v-select
                v-model="employee_data.department_id"
  ...
  computed: {
    ...
    districts_data() {
      let districts = this.get_master_districts_data.filter(district => {
        if (
          district.master_province_id == this.employee_data.master_province_id
        ) {
    ...
    form() {
      return {
        first_name: this.employee_data.first_name,
        last_name: this.employee_data.last_name,
        gender: this.employee_data.gender
      };
    },
